...
public class Level4 extends Application {
    ...
    public void start(Stage primaryStage) {
        ...
        SemiCircle semiCircle = new SemiCircle(310,110,0,180);
        ...
        ConnectorArc connectorArc = new ConnectorArc(180,120,90,90);
        ConnectorArc connectorArc1 = new ConnectorArc(300,210,270,90);
        ...
        pane4.getChildren().addAll(fullCircle.fullCircle(), fullCircle1.fullCircle(), emptyCircle.emptyCircle(), semiCircle.semiCircle(), connectorLineInsideCircle.connectorLine(),
                ...
                connectorArc.connectorArc(), connectorArc1.connectorArc(), perpendicularLine.perpendicularLine(), perpendicularLine1.perpendicularLine(),
                flatLine.flatLine(), flatLine1.flatLine(), flatLine2.flatLine());
