...
public class Level3 extends Application {
    ...
    public void start(Stage primaryStage) {
        ...
        ConnectorArc connectorArc = new ConnectorArc(200,150,90,90);
        ConnectorArc connectorArc1 = new ConnectorArc(295,240,270,90);
        ConnectorArc connectorArc2 = new ConnectorArc(220,270,270,90);
        ConnectorArc connectorArc3 = new ConnectorArc(240,190,90,90);
        ...
        SemiCircle semiCircle = new SemiCircle(305,140,0,180);
        SemiCircle semiCircle1 = new SemiCircle(305,180,270,180);

        pane3.getChildren().addAll(connectorArc.connectorArc(), connectorArc1.connectorArc(), connectorArc2.connectorArc(), connectorArc3.connectorArc(),
                connectorLine.connectorLine(), connectorLine1.connectorLine(), connectorLine2.connectorLine(), connectorLine3.connectorLine(),
                connectorLine4.connectorLine(), connectorLine5.connectorLine(), connectorLine6.connectorLine(),
                fullCircle.fullCircle(), fullCircle1.fullCircle(), fullCircle2.fullCircle(),
                perpendicularLine.perpendicularLine(), perpendicularLine1.perpendicularLine(), perpendicularLine2.perpendicularLine(),
                flatLine.flatLine(), flatLine1.flatLine(), flatLine2.flatLine(), flatLine3.flatLine(), flatLine4.flatLine(), semiCircle.semiCircle(), semiCircle1.semiCircle());
