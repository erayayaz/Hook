...
public class Level5 extends Application {
    ...
    public void start(Stage primaryStage) {
        ...
        SemiCircle semiCircle = new SemiCircle(260,115,90,180);
        SemiCircle semiCircle1 = new SemiCircle(260,85,0,180);
        SemiCircle semiCircle2 = new SemiCircle(330,85,270,180);
        ...
        ConnectorArc connectorArc = new ConnectorArc(250,190,270,90);
        ConnectorArc connectorArc1 = new ConnectorArc(300,125,0,90);
        ConnectorArc connectorArc2 = new ConnectorArc(190,95,90,90);
        ConnectorArc connectorArc3 = new ConnectorArc(320,250,270,90);
        ...
        pane5.getChildren().addAll(fullCircle.fullCircle(), fullCircle1.fullCircle(), fullCircle2.fullCircle(), fullCircle3.fullCircle(), emptyCircle.emptyCircle(), emptyCircle1.emptyCircle(),
                semiCircle.semiCircle(), semiCircle1.semiCircle(), semiCircle2.semiCircle(), connectorLineInsideCircle.connectorLine(), connectorLineInsideCircle1.connectorLine(),
                connectorLine.connectorLine(), connectorLine1.connectorLine(), connectorLine2.connectorLine(), connectorLine3.connectorLine(), connectorLine4.connectorLine(), connectorLine5.connectorLine(),
                connectorLine6.connectorLine(), connectorLine7.connectorLine(), connectorLine8.connectorLine(), connectorLine9.connectorLine(), connectorLine10.connectorLine(), connectorLine11.connectorLine(),
                connectorArc.connectorArc(), connectorArc1.connectorArc(), connectorArc2.connectorArc(), connectorArc3.connectorArc(),
                perpendicularLine.perpendicularLine(), perpendicularLine1.perpendicularLine(), perpendicularLine2.perpendicularLine(),
                flatLine.flatLine(), flatLine1.flatLine(), flatLine2.flatLine(),  flatLine3.flatLine(),  flatLine4.flatLine(),  flatLine5.flatLine(),  flatLine6.flatLine(),  flatLine7.flatLine());
